...
while running:
    ...
    eul_text = font.render(f"Euler Angles: {round(roll*(180/math.pi))}, {round(pitch*(180/math.pi))}, {round(yaw*(180/math.pi))}", True, (0, 0, 0))

    acc_text = font.render(f"Magnetometer Vector: {magVector}", True, (0,0,0))
